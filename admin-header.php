            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <button type="button" onclick="sawStatusBtn()" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                        ...
                        $sql123 = "SELECT * FROM notifications WHERE messageTo = 'admin' and (saw_status = 0 OR saw_status IS NULL); ";
                        ...
                        ?>">
                            <?php
                            $sql = "SELECT COUNT(notif_id) FROM notifications WHERE messageTo='admin' AND (saw_status = 0 OR saw_status IS NULL);";
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="db/<?php if (isset($_SESSION['admin_image'])) {echo $_SESSION['admin_image'];} ?>" alt="Header Avatar">
