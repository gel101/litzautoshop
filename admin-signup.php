                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" novalidate action="#">
                                        ...
                                        <div class="mb-4">
                                            <p class="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Litz Autoshop <a href="#" class="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</a></p>
                                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <!-- <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Litz Autoshop. Crafted with <i class="mdi mdi-heart text-danger"></i> by Angelo Malano -->
                            </p>
                        </div>
                    </div>
                </div>
