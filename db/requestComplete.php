...
$msg = $error = $cust_id =  $reqID = $reqEmail =  $totalprice =  $priceReason = "";
	...
	if($valid){
        ...
        function sendEmail($custLname, $reqID, $totalprice, $priceReason, $customerEmail, $customerName){
            $signature = "<br>";
        ...
        sendEmail($custLname, $reqID, $totalprice, $priceReason, $customerEmail, $customerName);
        }
...
$mechanic_id = $serviceRow['mechanic_id'];
