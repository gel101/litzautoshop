...
try {
    $msg = $car_img = $car_type = $carName = $model = $engine = $details = "";
    $error = "";
    $valid = true;
    ...
    if ($valid) {
        ...
        // } else {
			...
			$sql = mysqli_query($conn, "INSERT INTO car_rental(car_img, img1, img2, img3, img4, car_type, name, model, engine, status, details) VALUES ('$car_img', '$img1', '$img2', '$img3', '$img4', '$car_type', '$carName', '$model', '$engine', 'Available', '$details')");
			
            $msg = array("valid" => true, "msg" => "Car Rental Added!");
            echo json_encode($msg);
        // }
    } else {
