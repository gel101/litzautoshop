...
try {
    $msg = $error = $rentalcar_id = $car_img = $car_type = $name = $model = $engine = $details = "";
    $valid = true;
    ...
    if ($valid) {
        ...
        // $query = "SELECT * FROM cars WHERE car_type = '$car_type' AND name = '$name' AND model = '$model' AND engine = '$engine' AND rentalcar_id != '$rentalcar_id' AND status != 'archived' ";
        ...
        // } else {
            // Move the uploaded file to the desired location
                if ($fileTmpName != "") {
                    ...
                    $car_img = $destination;
                    $sql = mysqli_query($conn, "UPDATE car_rental SET car_img = '$car_img' WHERE rentalcar_id = '$rentalcar_id' ");
                }if ($fileTmpName1 != "") {
                    ...
                    $img1 = $destination1;
                    $sql = mysqli_query($conn, "UPDATE car_rental SET img1 = '$img1' WHERE rentalcar_id = '$rentalcar_id' ");
                }if ($fileTmpName2 != "") {
                    ...
                    $img2 = $destination2;
                    $sql = mysqli_query($conn, "UPDATE car_rental SET img2 = '$img2' WHERE rentalcar_id = '$rentalcar_id' ");
                }if ($fileTmpName3 != "") {
                    ...
                    $img3 = $destination3;
                    $sql = mysqli_query($conn, "UPDATE car_rental SET img3 = '$img3' WHERE rentalcar_id = '$rentalcar_id' ");
                }if ($fileTmpName4 != "") {
                    ...
                    $img4 = $destination4;
                    $sql = mysqli_query($conn, "UPDATE car_rental SET img4 = '$img4' WHERE rentalcar_id = '$rentalcar_id' ");
                }
                
                $sql = mysqli_query($conn, "UPDATE car_rental SET car_type = '$car_type', name = '$name', model = '$model', engine = '$engine', details = '$details' WHERE rentalcar_id = '$rentalcar_id' ");
               
                $msg = array("valid" => true, "msg" => "Rental Car Updated!");
                echo json_encode($msg);
        // }
    } else {
