                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    ?>
                                                <tr>
                                                    <th class="ps-0" scope="row">Profile Image :</th>
                                                    <td class="text-muted" id="img"><img class="img-fluid" style="max-width: 400px; height: auto;" src="db/<?php echo $data['img']; ?>" alt="Profile Image"></td>
                                                </tr>
                                                <tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <label for="" class="form-label">Phone Number</label><span id="phone_errr" class="text-danger"></span>
