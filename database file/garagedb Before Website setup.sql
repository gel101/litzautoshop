...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2024 at 03:42 PM
...
CREATE TABLE `carts` (
  ...
  `quantity` int(11) DEFAULT NULL,
  `leftQuantity` int(11) DEFAULT NULL,
  `details` text DEFAULT NULL,
...
CREATE TABLE `clientacc` (
  ...
  `acc_reason` varchar(225) NOT NULL,
  `status` varchar(25) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `client_documents` (
  ...
  `payslip_3m` varchar(225) NOT NULL,
  `electric_bill` varchar(225) NOT NULL,
  `brgy_clearance` varchar(225) NOT NULL,
  `validID_1` varchar(225) NOT NULL,
  `validID_2` varchar(225) NOT NULL,
  `marriage_contract` varchar(225) NOT NULL,
  `business_permit` varchar(225) NOT NULL,
  `bankStatement_3m` varchar(225) NOT NULL,
...
(123, 41, '2024-65a0a12f8adf6', '', '', '', '', '', '', '', '', '', 'Pending');
...
CREATE TABLE `notifications` (
  ...
  `cust_id` int(11) DEFAULT NULL,
  `messageTo` varchar(10) NOT NULL,
  `message` varchar(225) NOT NULL,
  `date` date NOT NULL,
  `transaction` varchar(10) NOT NULL,
  `status` varchar(30) NOT NULL,
  `saw_status` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `orders` (
  ...
  `date` date DEFAULT NULL,
  `noAccEmail` varchar(30) NOT NULL,
...
(13, 41, 'Angelo Malano', '2024-65a0a12f8adf6', 240000, NULL, NULL, NULL, NULL, '2024-01-12', '', 'car', 'Pending'),
...
CREATE TABLE `rent_transactions` (
  ...
  `driver_license` varchar(225) NOT NULL,
  `government_id` varchar(225) NOT NULL,
  `address_proof` varchar(225) NOT NULL,
...
CREATE TABLE `request_services` (
  ...
  `price` int(11) NOT NULL,
  `price_reason` varchar(225) NOT NULL,
...
--
ALTER TABLE `cars`
  MODIFY `car_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `spareparts_accessories`
  MODIFY `sparepart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
